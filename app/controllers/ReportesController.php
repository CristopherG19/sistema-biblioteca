...
class ReportesController {
    ...
    public function __construct() {
        ...
        if (!AuthController::esBibliotecario()) {
            header('Location: /SISTEMA_BIBLIOTECA/public/index.php?page=dashboard&error=' . urlencode('No tienes permisos para acceder a reportes'));
            exit;
        }
    }
    ...
    public function index() {
        try {
            ...
            header('Location: /SISTEMA_BIBLIOTECA/public/index.php?page=dashboard&error=' . urlencode('Error al cargar los reportes'));
            exit;
        }
    }
    ...
    public function prestamos() {
        try {
            ...
            header('Location: /SISTEMA_BIBLIOTECA/public/index.php?page=reportes&error=' . urlencode('Error al generar el reporte de préstamos'));
            exit;
        }
    }
    ...
    public function usuarios() {
        try {
            ...
            header('Location: /SISTEMA_BIBLIOTECA/public/index.php?page=reportes&error=' . urlencode('Error al generar el reporte de usuarios'));
            exit;
        }
    }
    ...
    public function libros() {
        try {
            ...
            header('Location: /SISTEMA_BIBLIOTECA/public/index.php?page=reportes&error=' . urlencode('Error al generar el reporte de libros'));
            exit;
        }
    }
    ...
    private function obtenerPrestamosPorMes($prestamoModel) {
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $datos[] = [
                ...
                'prestamos' => rand(10, 50) // Datos simulados
            ];
        }
        return $datos;
    }
    ...
    private function obtenerLibrosMasPrestados($prestamoModel) {
        // Simular datos de libros más prestados
        return [
    ...
    private function obtenerUsuariosMasActivos($prestamoModel) {
        // Simular datos de usuarios más activos
        return [
