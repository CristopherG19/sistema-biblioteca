    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2><i class="fas fa-edit text-primary me-2"></i>Editar Categoría</h2>
                    <p class="text-muted mb-0">Modifica la información de la categoría: <strong><?php echo htmlspecialchars($categoria['nombre']); ?></strong></p>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="/SISTEMA_BIBLIOTECA/public/index.php?page=categorias&action=actualizar">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="4" 
                                      placeholder="Descripción detallada de la categoría (opcional)..."><?= htmlspecialchars($categoria['descripcion']) ?></textarea>
                            <div class="form-text">
                        ...
                        <div class="bg-light p-3 rounded mb-3">
                            ...
                            <small>
                                <strong>ID de Categoría:</strong> <?= $categoria['idCategoria'] ?><br>
                                <strong>Creada:</strong> <?= isset($categoria['fecha_creacion']) ? date('d/m/Y', strtotime($categoria['fecha_creacion'])) : 'No disponible' ?>
                            </small>
                        </div>
