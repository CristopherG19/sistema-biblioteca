...
<div class="container my-4">
                        ...
                        <tbody>
                            <?php foreach ($reporteUsuarios['usuarios'] as $index => $usuario): ?>
                                <tr>
                                    ...
                                    <td class="py-3"><?php echo date('d/m/Y', strtotime($usuario['fecha_registro'])); ?></td>
                                    <td class="py-3">
    ...
    <div class="row mt-4 no-print">
        <div class="col-12 text-center">
            ...
            <a href="index.php?page=export&action=excel&tipo=usuarios" class="btn btn-primary me-2">
                <i class="fas fa-file-excel me-2"></i>Exportar Excel
            </a>
            <a href="index.php?page=export&action=pdf&tipo=usuarios" class="btn btn-info" target="_blank">
